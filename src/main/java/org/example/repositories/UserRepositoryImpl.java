...
//    }
//
//    public UserRepositoryImpl(HikariCP dataSource) {
...
//                    Post foundPost = postRepositoryImpl.findByIdWithoutUser(postId);
...
//    }
//
//    public User findByIdWithoutRoles(int userId) throws SQLException {
//        try (Connection connection = dataSource.connect();
//             PreparedStatement prepStmtSelectUserById = connection.prepareStatement(UsersSQL.SELECT_BY_ID.getQuery())
//        ) {
//            prepStmtSelectUserById.setInt(1, userId);
...
//    }
//
//    public User save(int userId, String newLogin, String newPassword) throws SQLException {
//        try (Connection connection = dataSource.connect();
