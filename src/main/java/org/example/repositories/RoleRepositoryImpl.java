...
//    }
//
//    public RoleRepositoryImpl(HikariCP dataSource) {
//        this.dataSource = dataSource;
//    }
//
//    public Role save(String roleName, String description) throws SQLException {
...
//                    User user = userRepository.findByIdWithoutRoles(userId);
//                    listUsers.add(user);
//                }
//
...
//    }
//
//    public Role findByIdWithoutItsUsers(int roleId) throws SQLException {
//        try (Connection connection = dataSource.connect();
//             PreparedStatement prepStmtSelectRoleById = connection.prepareStatement(RolesSQL.SELECT_BY_ID.getQuery())
//        ) {
//            prepStmtSelectRoleById.setInt(1, roleId);
...
//    }
//
//    public Role save(int roleId, String newRoleName, String newDescription) throws SQLException {
//        try (Connection connection = dataSource.connect();
...
//        Role foundRole = this.findById(roleId);
//
//        if (foundRole == null) {
