...
public class UserServiceImpl implements UserService {
    ...
    public User getUserById(int userId) {
        ...
        try {
            ...
            throw new RoleException("Error while getting a User", e);
        }
    }
    ...
    public User getUserByIdWithoutHisRoles(int userId) {
        ...
        try {
            ...
            throw new RoleException("Error while getting a User without his Roles", e);
        }
    }
    ...
    public User updateUserById(int userId, String newLogin, String newPassword) {
        ...
        try {
            ...
            throw new RoleException("Error while updating a User by ID", e);
        }
    }
    ...
    public void deleteUserById(int userId) {
        ...
        try {
            ...
            throw new RoleException("Error while deleting a User by ID", e);
        }
    }
}
